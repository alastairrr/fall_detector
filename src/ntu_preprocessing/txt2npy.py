...
From: https://github.com/shahroudy/NTURGB-D
'''
...
user_name = 'alast'
save_npy_path = 'ntu_npy/'
load_txt_path = 'nturgbd_skeletons_s001_to_s017/nturgb+d_skeletons/'
missing_file_path = 'ntu_rgb_missings.txt'
